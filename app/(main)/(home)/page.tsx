            ...
            <div className="col-lg-6">
              <div className="mv-ctn-box-left">
                ...
                <p>
                  ...
                  Vestibulum ultricies, neque inasd dfsae elementum ultricies,
                  ex feugiat lacus, sagittis faucibus mi gthddui at purus. Atote
                  nissim lorem et dis gnissim feugiat. Suspendisse sit amet est
                  euismod libero eleifend feugiat. Maecenas sollicitudin elit
                  ipsum. Aliquam egestas nibh nec erat interdum, nec facilisis
                  felis tincidunt. Proin linia mattis magna in semper. Aliquam
                  eu velit molestie, aliquam libero ac, ornare leo.
                </p>
                <p>
                  Suspendisse nec ligula nunc. Ut scelerisque eros vitae libero
                  interdum, a sollicitudin metus ullamcorper. Sed a viverra
                  lectus. Fusce sit amet ligula semper, euismod ligula in,
                  mollis elit. Praesent condimentum dui sed est semper ante id
                  elit tincidunt scelerisque ut quis odio.{" "}
                </p>
